...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_App2.default, { store: store }), document);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _formComponent = __webpack_require__(224);

	var _formComponent2 = _interopRequireDefault(_formComponent);

	var _readComponent = __webpack_require__(226);

	var _readComponent2 = _interopRequireDefault(_readComponent);

	var _reduxExample = __webpack_require__(227);

	var _reduxExample2 = _interopRequireDefault(_reduxExample);
	...
	var routes = _react2.default.createElement(
	      ...
	      _react2.default.createElement(_reactRouter.Route, { path: '/test/form', component: _formComponent2.default }),
	      _react2.default.createElement(_reactRouter.Route, { path: '/test/read', component: _readComponent2.default }),
	      _react2.default.createElement(_reactRouter.Route, { path: '/test/redux', component: _reduxExample2.default })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TestComponent = function (_Component) {
	  ...
	  function TestComponent() {
	    ...
	    _this.callName = _this.callName.bind(_this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nameAction = __webpack_require__(266);

	var _nameAction2 = _interopRequireDefault(_nameAction);

	var _clickerAction = __webpack_require__(278);
	...
	var ReduxExample = function (_Component) {
	  _inherits(ReduxExample, _Component);

	  function ReduxExample() {
	    _classCallCheck(this, ReduxExample);

	    var _this = _possibleConstructorReturn(this, (ReduxExample.__proto__ || Object.getPrototypeOf(ReduxExample)).call(this));
	    ...
	    //Binding functions that we created.
	    _this.callName = _this.callName.bind(_this);
	    _this.reduxAction = _this.reduxAction.bind(_this);
	    _this.addNumber = _this.addNumber.bind(_this);
	    _this.minusNumber = _this.minusNumber.bind(_this);

	    return _this;
	  }

	  _createClass(ReduxExample, [{
	    key: 'callName',
	    value: function callName() {
	    ...
	    key: 'minusNumber',
	    value: function minusNumber() {
	      this.props.minusAction();
	    }
	  }, {
	    key: 'reduxAction',
	    value: function reduxAction() {
	      this.props.getName();
	    }
	  }, {
	    key: 'render',
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'h1',
	              { onClick: this.reduxAction },
	              'This is the redux component'
	            ),
	            this.props.myName.map(function (name, i) {
	              return _react2.default.createElement(
	                'h2',
	                { key: i, onClick: _this2.reduxAction },
	                name.name
	              );
	            }),
	            _react2.default.createElement(
	...
	function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({
	    getName: _nameAction2.default,
	    minusAction: _clickerAction.minusAction,
	    addAction: _clickerAction.addAction
	  }, dispatch);
	};
	...
	module.exports = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(ReduxExample);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _clickReducer = __webpack_require__(279);

	var _clickReducer2 = _interopRequireDefault(_clickReducer);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	module.exports = (0, _redux.combineReducers)({
	  testReducer: _testReducer2.default,
	  clickReducer: _clickReducer2.default
	});
...
/***/ function(module, exports) {
	...
	function testReducer(state, action) {
	  return [{ name: 'Farhan', age: 17 }, { name: 'Adam', age: 20 }, { name: 'Stephanie', age: 17 }];
	}
